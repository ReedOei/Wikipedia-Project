...
class Link:
    def __init__(self, href, text, in_parentheses, in_paragraph, in_table, in_tr, in_list, divs=[], attributes=[]):
        self.href = href
        self.text = text
...
class Parser(HTMLParser):
    ...
    def handle_starttag(self, tag, attrs):
        if tag == 'table':
            ...
            self.divs.append(self.get_attribute(attrs, 'id'))
    ...
    def handle_endtag(self, tag):
        if tag == 'table':
            ...
            if self.link_level == 0:
                ...
                self.links.append(Link(href, self.link_data, in_parentheses, self.paragraph_level > 0, self.table_level > 0, self.tr_level > 0, self.list_level > 0, divs=self.divs, attributes=attributes))
